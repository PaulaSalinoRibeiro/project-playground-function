...
## Projeto de avaliação do modulo de Introdução à JavaScript e Lógica de Programação
...
## Esse projeto consistiu de 13 requisitos sendo que os 10 primeiros eram obrigatórios e os ultimos 3 foram bonus, todos foram testados, atigindo 100% dos requisitos propostos a seguir:
